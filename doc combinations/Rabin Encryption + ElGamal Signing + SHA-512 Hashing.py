...
class SecureSystem:
    ...
    def nurse(self):
        ...
        self.logger.log(f"Nurse encrypted data: {self.encrypted_data}")
        ...
        self.logger.log(f"Nurse digital signature: (r: {self.signature[0]}, s: {self.signature[1]})")
    ...
    def doctor(self):
        ...
        # Print message based on signature verification
        if valid:
            self.logger.log("Doctor verified the signature successfully.")
            print("Digital Signature matched. Verification successful.")
        else:
        ...
        self.logger.log(f"Doctor decrypted data (Patient Details): {decrypted_data}")
    ...
    def technician(self):
        ...
        if self.prescription:
            ...
            self.logger.log(f"Technician created message digest: {digest}")
