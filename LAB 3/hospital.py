...
def measure_performance(message_sizes):
    for size in message_sizes:
        ...
        # Print results
        print(
            f"Message Size: {size} bytes | Encryption Time: {encryption_time:.6f}s | Decryption Time: {decryption_time:.6f}s")


def main():
    message_sizes = [32, 64, 128, 256, 512, 1024, 2048]  # Sizes in bytes
    measure_performance(message_sizes)
